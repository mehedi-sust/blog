...
<link rel="stylesheet" href="css/style_dash.css" type="text/css" media="all">
...
<div class="body1">
  <div class="main">
    ...
    <header>
      ...
      <div class="wrapper">
        <ul id="icons">
          <li><a href="#" class="normaltip"><strong>Login</strong>
          <li><a href="#" class="normaltip"><strong>|</strong>
          <li><a href="#" class="normaltip"><strong>Sign Up</strong>
          <!--
...
<div class="body2">
  <div class="main">
    <section id="content">
          ...
          <form id="form_1" action="#" method="post">
            <div class="pad1">
              ...
              <div class="row_select">
                ...
                <div class="cols pad_left1"> Vacant room(s):<br>
                  <select>
                    <option>Any</option>
                    <option>1</option>
                    <option>2</option>
              ...
              <div class="row_select pad_bot1">
                <div class="cols"> Campus distance:<br>
                  <select>
                    <option>Any</option>
                    <option></option>
                    <option>...</option>
                ...
                <br>
                <div class="cols pad_left1"> <a href="#" class="button">Search Mess</a> </div>
              </div>
      ...
      <!-- This part is not necessary for my project-->
    ...
    <section id="content2">
      <div class="wrapper">
        <article class="col1">
          ...
          <!-- The follwing commented out part is not necessary for my project.-->
